...
\todo[inline]{Explicacion de la funcion, periodos}
...
En Los Ángeles es dónde encontramos \todo[inline]{Completar explicacion de los graficos}
...
Veamos que sucede si tomamos otra aerolínea, como es el caso de American Airlines. \todo[inline]{Completar American Airlines}

\todo[inline]{Explicacion de la funcion. Aclarar que es casi igual a la anterior pero con un termino de coseno extra}
...
\todo[inline]{Descripcion de graficos y mencionar los ECM}
...
% $ $\newline
% {\centering
%   \includegraphics[width=0.7\linewidth]{informe/imagenes/retrasosUnitedAirlinesATL.pdf}
%   \captionof{figure}{Retrasos - United Airlines\\}
% }
% $ $\newline
...
\todo[inline]{Reescribir conclusion, hacer enfasis en que las familias de funciones que mejor predicen para todas las aerolineas son similares}
